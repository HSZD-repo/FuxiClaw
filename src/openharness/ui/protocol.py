...
class AttachmentRef(BaseModel):
    """One uploaded file reference sent from the web frontend."""
...
class FrontendRequest(BaseModel):
    ...
    trust_session: bool | None = Field(
        default=None,
        description="When true with allowed true, switch this connection to FULL_AUTO (no further prompts).",
    )
    answer: str | None = None
    attachments: list[AttachmentRef] | None = None
    session_id: str | None = None
    summary: str | None = None
    action: Literal["stop", "skip", "wait"] | None = None
